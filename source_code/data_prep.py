...
os.system(f"mkdir Dataset/FMCG_SI")
os.system(f"mkdir Dataset/FMCG_SI/Annotations")
os.system(f"mkdir Dataset/FMCG_SI/JPEGImages")
os.system(f"mkdir Dataset/FMCG_SI/ImageSets")
os.system(f"mkdir Dataset/FMCG_SI/ImageSets/Main")
...
os.system(f"mv grocerydataset/ Dataset/")
##os.system(f"rm ShelfImages.tar.gz ")


# path to the annotation .csv file
path = 'Dataset/grocerydataset/annotations.csv'
# path to save all the .xml files
annot_save = 'Dataset/FMCG_SI/Annotations/'
# path to save all the images to train and test
image_save = 'Dataset/FMCG_SI/JPEGImages/'
# path to train and test splits.
split_save = 'Dataset/FMCG_SI/ImageSets/Main/'
# path to the training image folder
train_ = 'Dataset/grocerydataset/ShelfImages/train/'
# path to the testing image flder
test_= 'Dataset/grocerydataset/ShelfImages/test/'
...
with open(split_save+'train.txt', "w") as f:
    f.write(a)
